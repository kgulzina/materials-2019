...
- R and RStudio: make sure you have newish versions installed  (R 3.2.x; RStudio 1.1.463) 
...
This might get slightly frenzied! 😵😵😵

1.  Go to the repository  `sandbox` on the 585 GitHub organization at https://github.com/heike/sandbox. 

2. Make a remote copy of the repository by forking it to your github account.

3. In your repository, open the file story.md and add to the storyline. Commit your changes. 

4. Create a pull request to upload your changes to the original repository.
You might first have to update your fork to include changes made to the original repository (see next slides for details).

---

## Create a pull request

- A **pull request** is the final step in the collaboration process, essentially asking if the edits made to your copy can be incorporated into the original repository. 

1.  Make sure you are in your copy of the repository: look at the url - your user name should preface the repository name.  
...
3.  Click the "Create a Pull Request" button to continue the pull request. The owner of the original repository will now get a notification of a pull request on their main repository.

4.  Go ahead and accept this pull request. 

---5. Everybody should aim to add at least two pull requests.
